...
export class TilemapGeometry extends Geometry {
    constructor(indexBuffer) {
        ...
        this.vertSize = _a.vertSize;
        this.vertPerQuad = _a.vertPerQuad;
        this.stride = _a.stride;
        this.buf = buf;
    }
}
_a = TilemapGeometry;
TilemapGeometry.vertSize = 13;
TilemapGeometry.vertPerQuad = 4;
TilemapGeometry.stride = _a.vertSize * 4;
