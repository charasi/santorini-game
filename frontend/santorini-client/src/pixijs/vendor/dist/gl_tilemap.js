import { ExtensionType, GlProgram, Shader, UniformGroup } from 'pixi.js';
import { settings } from './settings.js';
import { TilemapAdaptor } from './TilemapPipe.js';
...
export class GlTilemapAdaptor extends TilemapAdaptor {
    constructor() {
        super(...arguments);
        this._shader = null;
        this.max_textures = settings.TEXTURES_PER_TILEMAP;
    }
    destroy() {
    ...
    init() {
        this._shader = new Shader({
            glProgram: GlProgram.from({
                ...
                fragment: gl_tilemap_fragment.replace('//include_textures', TileTextureArray.generate_gl_textures(this.max_textures))
            }),
            resources: {
